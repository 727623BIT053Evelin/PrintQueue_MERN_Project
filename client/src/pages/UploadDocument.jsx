...
const UploadDocument = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // If payment method is online, trigger Razorpay checkout
            if (paymentMethod === 'online') {
                ...
                const options = {
                    key: 'rzp_test_SjwwYyC9wTGeoO',
                    amount: order.amount,
                    currency: order.currency,
                    name: 'Printer Queue',
                    description: 'Payment for print jobs',
                    order_id: order.id,
                    handler: async (response) => {
                        try {
                            ...
                            const { data: verifyResponse } = await axios.post(`${API_URL}/api/payments/verify`, verifyData, config);
