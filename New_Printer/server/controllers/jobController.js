...
const createJob = async (req, res) => {
    ...
    try {
        ...
        const populatedJob = await Job.findById(createdJob._id).populate('printer', 'name location').populate('user', 'name email');
        req.io.emit('jobUpdated', { type: 'create', job: populatedJob });
